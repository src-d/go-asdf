...
- GitHub [issues](https://github.com/src-d/go-asdf/issues)*
...
- All PRs must be written in idiomatic Go, formatted according to [gofmt -s](https://golang.org/cmd/gofmt/), [goimports](https://godoc.org/golang.org/x/tools/cmd/goimports), and without any warnings from [go lint](https://github.com/golang/lint) nor [go vet](https://golang.org/cmd/vet/).
